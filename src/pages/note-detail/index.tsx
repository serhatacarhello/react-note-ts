      ...
      <Container className="d-flex flex-column">
        <Card>
          <Card.Header>
            <Card.Title className="d-flex justify-content-between  align-items-center flex-wrap ">
              <Stack direction="horizontal" className="flex-wrap">
                <h3>Note Başlığı:</h3>
                <Header title={note?.title} Tag="h3" design="text-capitalize" />
              </Stack>
              {/* buttons */}
          ...
          <Card.Footer className="text-muted">
            <Stack direction="horizontal" className="flex-wrap gap-2 my-1">
              <Header title="Etiketler:" Tag="h5" design="fw-normal" />
              {note.tags?.map((tag) => (
                <Badge
                  bg="secondary"
